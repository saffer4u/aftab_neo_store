...
FetchUserDataModel fetchUserDataModelFromJson(String str) =>
    FetchUserDataModel.fromJson(json.decode(str));

String fetchUserDataModelToJson(FetchUserDataModel data) =>
...
class FetchUserDataModel {
  ...
  factory FetchUserDataModel.fromJson(Map<String, dynamic> json) =>
      FetchUserDataModel(
        userMessage: json["user_msg"]==null?null:json["user_msg"],
        status: json["status"] == null ? null : json["status"],
        data: json["data"] == null ? null : Data.fromJson(json["data"]),
      );

  Map<String, dynamic> toJson() => {
        "user_msg":userMessage==null?null:userMessage,
