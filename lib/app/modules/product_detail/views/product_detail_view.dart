import 'package:aftab_neo_store/app/modules/product_detail/views/product_detail_view_desktop.dart';
...
class ProductDetailView extends GetView<ProductDetailController> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, cnstrn) {
      if (cnstrn.maxWidth > 600) {
        return ProductDetailViewDesktop();
      } else {
        return Scaffold(
          appBar: customAppBar(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  border:
                                      Border.all(color: GREY_COLOR.shade200)),
                                ...
                                builder: (_) {
                                  return Image.network(
                                    controller
                                        ...
                                        .image!,
                                    fit: BoxFit.contain,
                                    loadingBuilder: Get.find<GlobalController>()
                                        .loadingBuilder,
                                  );
                                },
                              ),
